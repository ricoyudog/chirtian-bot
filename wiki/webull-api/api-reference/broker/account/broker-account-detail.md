...
method: "GET"
endpoint: "/openapi/broker/account/nd/detail"
rate_limit: "See Webull API documentation"
source: "https://developer.webull.hk/apis/docs/reference/broker-api/broker-account-detail"
updated: "2026-05-17"
...
**Source:** [https://developer.webull.hk/apis/docs/reference/broker-api/broker-account-detail](https://developer.webull.hk/apis/docs/reference/broker-api/broker-account-detail)

Broker APIAccount (ND)Get Virtual Account Detail
Get Virtual Account Detail
Ask AI
GET
https://hk-broker-api.uat.webullbroker.com/openapi/broker/account/nd/detail

• Function description: Retrieve details information for a specific virtual account.
...
Virtual Account ID to retrieve details for.
...
REQUESTS
	...
	headers = {
	  ...
	  'x-timestamp': '2026-05-17T14:37:51Z',

	  'x-signature-version': '1.0',

	  'x-signature-algorithm': 'HMAC-SHA1',

	  'x-signature-nonce': '10423157384879515448289719',

	  'x-version': 'v2',

	  'x-signature': '48523321828452216439442252'

	}

	conn.request("GET", "/openapi/broker/account/nd/detail?account_id=943a9802f6c14983b3b4755c69c01717", payload, headers)
...
```
GET https://hk-broker-api.uat.webullbroker.com/openapi/broker/account/nd/detail
```
