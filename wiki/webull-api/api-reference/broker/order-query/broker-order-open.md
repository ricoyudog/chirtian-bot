...
title: "Open Order"
method: "GET"
endpoint: "/openapi/broker/trade/order/open"
rate_limit: "See Webull API documentation"
source: "https://developer.webull.hk/apis/docs/reference/broker-api/broker-order-open"
updated: "2026-05-17"
...
**Source:** [https://developer.webull.hk/apis/docs/reference/broker-api/broker-order-open](https://developer.webull.hk/apis/docs/reference/broker-api/broker-order-open)

Broker APIOrderOrder QueryOpen Order
Open Order
Ask AI
GET
https://hk-broker-api.uat.webullbroker.com/openapi/broker/trade/order/open

• Function description: Get current pending orders list with pagination support.
...
REQUESTS
	...
	headers = {
	  ...
	  'x-timestamp': '2026-05-17T14:38:42Z',

	  'x-signature-version': '1.0',

	  'x-signature-algorithm': 'HMAC-SHA1',

	  'x-signature-nonce': '63331041746212496952552766',

	  'x-version': 'v2',

	  'x-signature': '87131346931586919938478515'

	}

	conn.request("GET", "/openapi/broker/trade/order/open?account_id=20150320010101000&page_size=10&last_client_order_id=THI82O5JB7MQ2K76LL5FSDS2CB", payload, headers)
...
```
GET https://hk-broker-api.uat.webullbroker.com/openapi/broker/trade/order/open
```
...
```json
import http.clientconn = http.client.HTTPSConnection("hk-broker-api.uat.webullbroker.com")payload = ''headers = {  'Accept': 'application/json',  'x-timestamp': '2026-05-17T14:38:42Z',  'x-signature-version': '1.0',  'x-signature-algorithm': 'HMAC-SHA1',  'x-signature-nonce': '63331041746212496952552766',  'x-version': 'v2',  'x-signature': '87131346931586919938478515'}conn.request("GET", "/openapi/broker/trade/order/open?account_id=20150320010101000&page_size=10&last_client_order_id=THI82O5JB7MQ2K76LL5FSDS2CB", payload, headers)res = conn.getresponse()data = res.read()print(data.decode("utf-8"))
```
